...
The catalyst I've selected is the United States 2026 Midterm Elections. This is a _structural_ catalyst, constitutionally mandated to occur every two years (whether Trump likes it or not). In today's heightened polarisation, we can extrapolate that political advertising spending will increase.
...
Broadcast television still carries the lion's share of political advertising in the United States (approx. 49% and $5.4B spending), specifically local TV broadcasters and broadcast station groups. However, Connected TV (CTV) is the fastest-growing media type, where spending is estimated to surge to $2.6B this year.
...
The cyclicity of political advertising is embedded in the Broadcasting industry, and it's very easy to observe this pattern from their financials. FY2025 was the trough, and we're on the ascent as political spending kicks into gear for FY2026. In a sense, judging a broadcaster on off-year earnings alone is like measuring a ski resort's revenue in July and concluding the business is failing.
...
2. Retransmission fees

- Cable/satellite/streaming TV distributors paying broadcasters to carry their local stations

3. Digital Media Operations

Local TV is extremely scale-driven, and these retransmission fees (i.e. large predictable cash streams) in particular had been critical to funding acquisitions in aggressive expansion.
...
Interestingly, this gives rise to peculiar paradoxes. On face value when exploring companies, I noticed that many still generate strong cash flow, with very low valuation multiples. Even normalising for the political cycle, stations are still highly profitable. I hypothesise this disparity reflects the equity market discounting the long-term decline risk plus the heavy leverage.
...
_"Scripps is a declining legacy TV broadcaster buried in $2.7B of debt with a $717M preferred stock obligation to Warren Buffett. Even worse, this noose is tightening as a 9% cumulative coupon compounds and deferred dividends accrue. Meanwhile cord-cutting is killing it, and it can't even cover its interest in off-years. The market prices common equity as a near-zero residual claim on a business that mostly belongs to creditors and Berkshire Hathaway"_
...
Manageable, not catastrophic, but the direction is clear. And importantly, this assumes the current rate of decline holds. There's no guarantee it will.
...
From the FY2025 10-K figures, distribution revenue (Local Media) accounts for ~35% of total company revenue. That sounds like a lot, but I believe this overstates the actual economic exposure.
...
Then there's the ascendancy of ATSC 3.0, or NextGen TV. This represents a fundamental upgrade to OTA itself. It enables 4K HDR picture quality, immersive audio, and can even blend OTA signals with broadband for interactive features like on-demand replays and targeted ads.
...
Station presence in high-OTA markets is one thing; giving cord-cutters a reason to actually switch is another. On the hardware side, Scripps has invested in reducing friction with its Tablo device, which enables whole-home OTA viewing and recording without a subscription or monthly fees; essentially a modern DVR for cord-cutters. No peer has made a comparable consumer play. But the bigger draw is content, and live sports is the last reason people keep cable.
...
So where does this leave us? The market sees a declining legacy broadcaster drowning in debt, and it's not entirely wrong. Cord-cutting is real, digital migration is real, and the leverage is genuinely dangerous. But the operational picture is more nuanced than that narrative suggests.

Scripps owns more broadcast spectrum than any peer, reaches 38% of U.S. TV households, and has been quietly repositioning around OTA, CTV, live sports and datacasting; the very channels cord-cutters are migrating to. The 2026 midterms will flood the sector with political ad dollars, and Scripps' station footprint sits squarely in the swing states where that spending concentrates.
